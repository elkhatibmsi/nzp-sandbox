...
class nzpOffCanvasLayout extends LayoutDefault implements PluginFormInterface {
    ...
    */
    ...
    public function buildConfigurationForm(array $form, FormStateInterface $form_state) 
    {
        ...
        $form['oc_full_page_toggle']= [
          '#type' => 'checkbox',
          '#default_value' => FALSE,
          '#title' => t('toggle fullscreen'),
          '#default_value' => !empty($configuration['oc_full_page_toggle']) ? TRUE : FALSE,
   ...
   */
    public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
        ...
        $this->configuration['oc_full_page_toggle'] = $form_state->getValue('oc_full_page_toggle');
